...
<body>
  ...
  <section class="banner-area relative">
    <div class="homeslider owl-carousel">
      <!-- Slide 1 -->
      <div class="slide-item" style="background-image: url('<?= base_url('assets/img/slider1.jpg'); ?>'); background-size: cover; background-position: center;">
        <div class="overlay overlay-bg"></div>
        <div class="container">
          <div class="row fullscreen align-items-center justify-content-between">
            <div class="col-lg-6 col-md-6 banner-left">
              <h1 class="text-white">PT. CRT KABELITA</h1>
              <p class="text-white">Kami perusahaan yang bergerak dalam Bidang Harness Audio video otomotif dan Automotive accesories</p>
              <a href="<?= base_url('site/about'); ?>" class="primary-btn text-uppercase">Tentang Kami</a>
            </div>
          </div>
        </div>
      </div>
      <!-- Slide 2 -->
      <div class="slide-item" style="background-image: url('<?= base_url('assets/img/slider2.jpg'); ?>'); background-size: cover; background-position: center;">
        <div class="overlay overlay-bg"></div>
        <div class="container">
          <div class="row fullscreen align-items-center justify-content-between">
            <div class="col-lg-6 col-md-6 banner-left">
              <h1 class="text-white">Solusi Inovatif</h1>
              <p class="text-white">Kabel dan aksesoris otomotif terpercaya</p>
              <a href="<?= base_url('site/about'); ?>" class="primary-btn text-uppercase">Pelajari Lebih Lanjut</a>
            </div>
          </div>
        </div>
      </div>
      <!-- Tambahkan slide tambahan jika perlu -->
    </div>
  </section>
  ...
  <div class="modal fade" id="register" tabindex="-1" role="dialog" aria-labelledby="exampleModalFormTitle" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <center><br><p>CRT <a href='' title='' target='_blank'>KABELITA</a></p></center>
      </div>
    </div>
  </div>
